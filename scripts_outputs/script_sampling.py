...
##### Parameters ##### (Keep this part all the time. You need this part for Part I, II, III, and IV)
queue_type = 'continuous'   # 'discrete' or 'continuous' # queue type (block one of this line and the next line in execution)
...
#     file_name = 'Give_a_file_name_you_like_test1'
#     NN_sample1.Sample_Generation(Sample_size = 2, K = K, file_name = file_name)
...
NN_sample1.plot_sample_pdf(
    generate_new_samples = True, number_of_new_samples = 15, file_name_for_new_samples='Give_a_name_you_like'
)
